...
public class GoogleSettings {
  ...
  public static final String CLIENT_ID = "sonar.auth.ibm.clientId.secured";
  public static final String CLIENT_SECRET = "sonar.auth.ibm.clientSecret.secured";
  public static final String ENABLED = "sonar.auth.ibm.enabled";
  public static final String ALLOW_USERS_TO_SIGN_UP = "sonar.auth.ibm.allowUsersToSignUp";

  public static final String LOGIN_STRATEGY = "sonar.auth.ibm.loginStrategy";
  public static final String LOGIN_STRATEGY_PROVIDER_ID = "Use IBM intranet address";
  public static final String LOGIN_STRATEGY_DEFAULT_VALUE = LOGIN_STRATEGY_PROVIDER_ID;

  public static final String CATEGORY = "ibm";
  public static final String SUBCATEGORY = "authentication";

  private final Settings settings;

  public ibmSettings(Settings settings) {
  ...
  public static List<PropertyDefinition> definitions() {
    return Arrays.asList(
      PropertyDefinition.builder(ENABLED)
        .name("Enabled")
        .description("Enable IBM users to login. Value is ignored if client ID and secret are not defined.")
        .category(CATEGORY)
      ...
      PropertyDefinition.builder(CLIENT_ID)
        .name("Client ID")
        .description("Client ID provided by IBM when registering the application.")
        .category(CATEGORY)
        .subCategory(SUBCATEGORY)
        .index(2)
        .build(),
      PropertyDefinition.builder(CLIENT_SECRET)
        .name("Client Secret")
        .description("Client secret provided by IBM when registering the application.")
        .category(CATEGORY)
        .subCategory(SUBCATEGORY)
        .index(3)
        .build(),
